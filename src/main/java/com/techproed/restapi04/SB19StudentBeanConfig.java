...
public class SB19StudentBeanConfig {
	...
	@Bean
	CommandLineRunner commandLineRunner2(SB16StudentBeanRepository studentRepsoitory) {
		return args -> {
			SB15StudentBean aliCan = new SB15StudentBean(101L, "Ali Can", "ac@gmail.com", LocalDate.of(2002, Month.JANUARY, 21));
			SB15StudentBean veliHan = new SB15StudentBean(102L, "Veli Han", "vn@gmail.com", LocalDate.of(2000, Month.FEBRUARY, 5));
